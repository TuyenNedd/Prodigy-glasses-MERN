                        ...
                        <article>
                          <div className="mt-4 p-5 leading-4">
                            <p>
                              ...
                              review your purchases. Be sure to explain why you
                              like or dislike the product and focus on the
                            ...
                            <p>
                              Please refrain from including any of the following
                              in your review:
                            </p>
                            <ul className="pl-4 mb-4">
                              ...
                              <li className="mb-1">
                                Advertising, spam, references to other websites
                                or retailers
                              </li>
                              <li className="mb-1">
                  ...
                  <fieldset className="mt-8">
                    ...
                    <div className="body-text mt-2">
                      ...
                      <div className="hint-text">
                        ...
                        <span className="TradeGodthicCn text-xs text-[#00000094] ml-1">
                          Make your review great: Describe what you liked, what
                          you didn’t like, and other key things shoppers should
                          know.
                        </span>
                      </div>
                    </div>
                    ...
                    <div
                      className={`submit-review mt-6 ${
                        !content.trim() || star < 1 ? "pointer-events-none" : ""
                      }`}
                    >
