              ...
              <div className="search-results w-full lg:w-3/4 lg:pt-6 pt-4">
                <div className="flex lg:flex-row lg:items-start flex-col">
                  <div className="lg:px-0">
                    <p className="lg:text-base text-sm font-custom-1 uppercase tracking-wider leading-tight text-secondary lg:mb-6 mb-4 TradeGodthic-BoldCn">
                      Popular Searches:
                    </p>

                    <ul className="ITCGara">
                      <li>
                        <a className="block no-underline font-subheading lg:text-3xl text-lg tracking-wide leading-none text-black lg:mb-4 mb-4">
