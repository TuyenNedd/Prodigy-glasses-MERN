...
// const ModalAddProduct = ({ isModalOpen, handleCancel, onFinish, handleChangeSelect, stateProduct, handleOnchange, handleOnchangeAvatar, handleOnchangeAvatarImageHover , fetchTypeProduct }) => {
