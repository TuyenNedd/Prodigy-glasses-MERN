                ...
                >
                  <div className="product-item__meta">
                    <div className="text-left">
                      ...
                      <h2 className="product-title product-item__title my-0 TradeGodthic-BoldCn">
                        <span className="TradeGodthic-BoldCn">{type}</span>
                      </h2>
                    </div>
