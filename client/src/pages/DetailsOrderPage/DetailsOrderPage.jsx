...
import { formatDate, addDayFormat, convertPrice } from "../../utils";
              ...
              <div className="break-all">
                ...
                <div className="bg-gray-100 rounded-[4px] relative h-24 mb-7">
                  <div className="absolute -bottom-6 left-3 rounded-full overflow-hidden border-3 border-white aspect-square w-24">
                    <img src={user?.avatar || "/images/none-user.png"} alt="" />
                  </div>
                </div>
                ...
                <div className="text-base">
                  <div className="py-1">
                    <span>
                      ...
                      &nbsp;&nbsp;Email
                      {"  "}
                      <span className="TradeGodthic-BoldCn">{user?.email}</span>
                    </span>
                  </div>
                  <div className="py-1">
                    <span>
            ...
            <div className="detailsOrder rounded-md bg-white h-fit overflow-hidden TradeGodthicCn">
              <div className="flex flex-col gap-2 p-4">
                ...
                <div className="rounded-[4px] flex justify-between">
                  ...
                  <span className="TradeGodthicCn">{data?.paymentMethod}</span>
                </div>
                <div className="rounded-[4px] flex justify-between">
                  <span className="TradeGodthicCn text-base">Payment time</span>
                  <span className="TradeGodthicCn">
                    {/* {paymentTime}{" "} */}
