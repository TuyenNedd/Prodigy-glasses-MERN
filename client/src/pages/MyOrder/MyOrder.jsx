              ...
              <div className="lg:px-6 px-4 gap-5 columns-1 lg:columns-2 xl:columns-3">
                {data?.map((order) => {
                  ...
                  const estimatedAfterThreeDay = order.updatedAt
                    ? format(addDays(new Date(order.updatedAt), 3), " MMM dd", {
                        locale: enUS,
                      })
                    : "N/A";
                  const estimatedAfterFiveDay = order.updatedAt
                    ? format(addDays(new Date(order.updatedAt), 5), " MMM dd", {
                        locale: enUS,
                      })
                    : "N/A";
                          ...
                          >
                            <div className="flex gap-2">
                              ...
                              <div className="TradeGodthic-BoldCn">
                                {order.isDelivered ? (
                                  <>
                                    <span>Delivered {formattedDeliveryAt}</span>
                                    <br />
                              ...
                              <div className="flex gap-3 justify-end">
                                <div>
                                  {order.isDelivered ? (
                                    ...
                                    <ButtonOutline
                                      customClass={"!py-2 !px-4 !text-sm mt-4"}
