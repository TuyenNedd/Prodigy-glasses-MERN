          ...
          <div className="   w-full lg:max-w-full mt-[-100px] mx-auto flex flex-col pt-8">
            <div className="    flex-col mt-10 cursor-pointer lg:hidden">
              <div className=" w-[75%] py-5 m-auto flex items-center justify-between border-t border-b	">
                <div className=" flex  ITCGara" onClick={() => setShow(!show)}>
                ...
                <div className=" bg-[#f48029] text-white flex flex-col ">
                  <div className=" w-[65%] mx-auto py-5">
                    <div className="flex justify-between border-b items-center border-[rgba(248,172,116,0.34)] pb-2">
                      ...
                      <div className="TradeGodthicCn pl-2"> $130.00</div>
                    </div>
            ...
            <div className="comten w-[70%] m-auto pt-8 mt-6 ">
              ...
              <div className="  lg:w-full border-[1px] ">
                <div className="border-b mx-auto  p-4 border-[#e6e6e6] grid gap-4 grid-cols-1  lg:grid-cols-2   ">
                  <div className=" rounded bg-[#5a31f4] lg:w-auto  lg:rounded">
                  ...
                  <div className=" rounded bg-[#ffc439] lg:pl-3 lg:w-auto  lg:rounded">
                    <button className="flex h-11 items-center border-none  w-full justify-center rounded  ">
                      <img
                        className="h-5"
              ...
              <input
                placeholder="Email "
                className=" w-full border h-[46px] rounded p-1 px-3 mt-4 TradeGodthicCn focus:border-2 focus:border-black dark:focus:ring-black focus:invalid:ring-black"
              />
              ...
              <input
                placeholder="Country"
                className="border-2 w-full h-[46px] rounded p-1 px-3 mt-4  text-sm TradeGodthicCn focus:border-2 focus:border-black dark:focus:ring-black "
              />
              <div className="flex gap-2">
                <input
                  placeholder="First name(optional)"
                  className="border w-1/2 h-[46px] rounded p-1 px-3 mt-4 text-sm TradeGodthicCn  focus:border-2 focus:border-black dark:focus:ring-black"
                />
                <input
              ...
              <input
                placeholder="Address"
                className="border w-full h-[46px] rounded p-1 px-3 mt-4  text-sm TradeGodthicCn focus:border-2 focus:border-black dark:focus:ring-black"
              />
              <input
              ...
              <div className="flex justify-between items-center mt-4 border-b mb-4 pb-12">
                ...
                <button className="bg-black tracking-wide text-white w-[188px] h-[60px] rounded  text-sm  TradeGodthicCn">
