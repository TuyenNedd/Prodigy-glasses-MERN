...
const PaymentPage = () => {
  ...
  return (
    <div className=" flex overflow-auto  ">
      <div className="w-3/5 h-full lg:w-full m-auto">
        <div className="flex flex-col">
          <div className="img-logo ml-28 ">
            <img
          ...
          <div className=" w-full lg:max-w-full mt-[-100px] mx-auto flex flex-col pt-8">
            <div className="hidden  lg:flex flex-col mt-10 cursor-pointer">
              <div className=" w-[75%] py-5 m-auto flex items-center justify-between	">
                <div
                  className=" flex border-t border-b p-4 ITCGara"
