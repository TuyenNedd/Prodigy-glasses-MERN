...
const PaymentPage = () => {
  ...
  const [deliveredAt] = useState(null);
  const [paidAt] = useState(null);
                ...
                >
                  <Radio value="fast">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold text-priCo">30.000₫</span>
                    </div>
                  </Radio>
                  <Radio value="economical">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold text-priCo">15.000₫</span>
                    </div>
                  </Radio>
                </Radio.Group>
              </div>
